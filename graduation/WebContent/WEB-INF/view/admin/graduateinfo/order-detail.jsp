...
%>
<%
	Graduateinfo op 	= (Graduateinfo) request.getAttribute("graduateinfo");
 %>
...
<div class="pageContent">
	<form method="post" action="#" id="add-student-grade" class="student-form pageForm required-validate">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>开题日期：</label>
				<input type="text" size="30" value="<%=op.getGdiDate() %>"  readonly="true"/>
			</p>
			<div class="divider"></div>
			<p>
				<label>开题地点：</label>
				<input type="text" size="30" value="<%=op.getGdiPlace() %>"  readonly="true"/>
			</p>
			<div class="divider"></div>
			<p>
				<label>答辩序号：</label>
				<input type="text" size="30" value="<%=op.getGdiNumber() %>"  readonly="true"/>
			</p>
			<div class="divider"></div>
			<dl class="nowrap">
				<dt>评审教师：</dt>
