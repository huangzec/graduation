...
<body scroll="no">
		...
		<div id="header">
			<div class="headerNav">
				...
				<ul class="nav">
					...
					-->
					<li><a href="<%=basePath %>user/site.do?id=35" target="_back" width="600">去网站</a></li>
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree">
							<li><a href="<%=basePath %>user/list.do" target="navTab" rel="userListview">用户列表</a></li>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							<p>您好: <a href="###" target="_blank">系统管理员</a></p>
						</div>
	...
	<div id="footer">Copyright &copy; 2014 <a href="#" target="dialog"></a> @:huangzec@foxmail.com</div>
