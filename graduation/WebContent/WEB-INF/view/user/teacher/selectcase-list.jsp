					...
					<div class="widget-content">
						<div class="tabbable">
							<ul class="nav nav-tabs">
							  <li class="active">
							    <a href="<%=basePath %>user/topic/selectcase.do?topic=teacher">本人课题</a>
							  </li>
							  <li><a href="<%=basePath %>user/topic/selectcase.do?topic=student">学生课题</a></li>
							</ul>
						</div>
											 	...
											 	<tbody>
											 		...
											 		<tr>
											 			...
											 			<td>
															...
															<input type="hidden" name="topictype" value="2" />
														</td>
											 		</tr>
											 		<% } } } %>
											 	</tbody>
