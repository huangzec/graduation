			...
			<div class="span9">				
				...
				<div class="widget widget-table">										
							...
							<table class="table table-striped table-bordered">
								<tr>
									...
									<td colspan="6">
										...
										<input type="hidden" name="title" value="<%=(Verify.isEmpty(tbtopic.getTopName()) ? "" : tbtopic.getTopName()) %>" />
								...
								<tr>
									<td colspan="6">
										<div>
											毕业设计内容要求：
											<script id="conRequest" name="conRequest" type="text/plain">
								...
								<tr>
									<td colspan="6">
										<div>
											主要参考资料:
											<script id="refMaterial" name="refMaterial" type="text/plain">
								...
								<tr>
									<td colspan="6">
										<div>
											毕业设计工作计划：
											<script id="workPlane" name="workPlane" type="text/plain">
								...
								<tr>
									<td colspan="6">
										<ul>
											<li>
												接收任务日期 
												<input type="text" name="receipttime" value="<%=HResponse.formatEmpty(Verify.isEmpty(taskdoc) ? "" : taskdoc.getReceiptTime(), request) %>" id="receiptTime" data-date-format="yyyy-mm-dd" />
											</li>
											<li>
												要求完成任务日期
												<input type="text" name="finishtime" value="<%=HResponse.formatEmpty(Verify.isEmpty(taskdoc) ? "" : taskdoc.getFinishTime(), request) %>" id="finishTime" data-date-format="yyyy-mm-dd" />
											</li>
					...
					<div style="float: right;">
  						<button class="btn btn-primary" id="task-edit" type="button">修改</button>
					</div>				
				</div>
			</div> <!-- /span9 -->						
		</div> <!-- /row -->		
...
<script type="text/javascript">
    var conRequest = UE.getEditor('conRequest', {'enterTag': ''});
    var refMaterial = UE.getEditor('refMaterial', {'enterTag': ''});
    var workPlane = UE.getEditor('workPlane', {'enterTag': ''});
