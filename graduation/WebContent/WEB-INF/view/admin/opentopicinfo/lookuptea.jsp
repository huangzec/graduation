...
<%
 ...
 %>
<form id="pagerForm" action="<%=basePath %>admin/opentopicinfo/lookuptea.do">
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="<%=basePath %>admin/opentopicinfo/lookuptea.do" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar">
