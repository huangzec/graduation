...
<div class="pageContent">
	<form method="post" action="<%=basePath %>admin/opentopicinfo/order.do" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>组　　别：</label>
				<select name="begroup" class="begroup required" >
			...
			<dl class="nowrap">
				...
				<dd>
					...
					<a class="btnLook" href="<%=basePath %>admin/opentopicinfo/lookup.do" lookupGroup="stu">查找带回</a>
			...
			<dl class="nowrap">
				...
				<dd>
					...
					<a class="btnLook" href="<%=basePath %>admin/opentopicinfo/lookuptea.do?place=<%=room.getNumber() %>" lookupGroup="tea">查找带回</a>
					<span class="info">(查找回带)</span>
				</dd>
			</dl>
			<div class="divider"></div>
