...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<%=basePath %>admin/topicorderreview/topictotallist.do" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li class="line">line</li>
			<li><a class="icon" href="javascript:$.printBox('topic-submit-list')"><span>打印</span></a></li>
			<li class="line">line</li>			
		</ul>
	</div>
	<div id="topic-submit-list">
