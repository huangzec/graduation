...
<div class="pageContent">
	<form method="post" action="<%=basePath %>admin/opentopicinfo/<%=(Verify.isEmpty(action) ? "" : action) %>" id="score-search" class="pageForm required-validate" onsubmit="return navTabSearch(this);">
		<div class="pageFormContent" id="opt-score-search" layoutH="56">
			<div class="divider"></div>
			<p>
				<%=(Verify.isEmpty(message) ? "" : message) %>
			</p>
			<div class="divider"></div>
			<div>
				<label>请选择查询条件：</label>
