...
<head>
	...
	<link href="<%=basePath %>cscon/login.css" rel="stylesheet" type="text/css" media="screen" />
	<link href="<%=basePath %>cscon/demo.css" rel="stylesheet" type="text/css" media="screen" />
...
<body>
	...
	<div class="footer">
		<div id="footer">
			...
			指导老师:姚敦红、张文
			All Rights Reserved.
			<a href="<%=basePath %>admin/index.do" >进入后台管理</a>
		</div>
	</div>
</body>
</html>
