  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        container_div.html('<a href="javascript:void(0)" class="chzn-single"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" id="chosen-input-id"/></div><ul class="chzn-results"></ul></div>');
      }
    ...
    Chosen.prototype.no_results = function(terms) {
      ...
      no_results_html = $('<li class="no-results" id="other-result-id">' + terms + ' "<span></span>"</li>');
      var $formField  = $(this.form_field);
      no_results_html.find("span").first().html(terms);
      no_results_html.click(function() {
          var historyFlag     = 0;
          if($("#department-history-flag-id").attr("checked")) {
              historyFlag     = 1;
          }
		  window.location.href    = $formField.attr("rel") + terms + "&flag=" + historyFlag;
      });
