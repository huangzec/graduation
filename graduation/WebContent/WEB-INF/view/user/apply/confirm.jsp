			...
			<div class="span9">
				...
				<div class="widget">										
					...
					<div class="widget-header">
						<h3>答辩确认</h3>
						<div class="f-right" style="color: #f00;font-size: 14px;margin-right: 50px;">${message }</div>
					</div> <!-- /widget-header -->
					<div class="widget-content">
						<div class="tabbable">
							<ul class="nav nav-tabs">
							  <li class="active">
							    <a href="#1" data-toggle="tab">开题答辩确认</a>
							  </li>
							  <li><a href="<%=basePath %>user/apply/finishconfirm.do">毕业答辩确认</a></li>
							</ul>
							<br />
											...
											<table class="table table-striped table-bordered">
												...
												<tbody>
													...
													<tr>
														...
														<td><button class="btn btn-info" type="button">查看文档</button></td>
