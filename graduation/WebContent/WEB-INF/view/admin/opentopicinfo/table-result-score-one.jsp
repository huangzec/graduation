...
%>
<%
	List<Gradeone> scoreList 	= (List<Gradeone>) request.getAttribute("scoreList");
 ...
 %>
<form id="pagerForm" method="post" action="<%=basePath %>admin/opentopicinfo/tableonescore.do">
...
<div class="pageHeader">
	<form method="post" action="<%=basePath %>admin/opentopicinfo/tableonescore.do" id="score-search-list" class="pageForm required-validate" onsubmit="return navTabSearch(this);">
	<div class="searchBar">
		<div>
			请选择查询条件：
						...
						for(int i = 0; i < stuList.size(); i ++) {
							...
							if(!Verify.isEmpty(scoreList)) {
								for(int j = 0; j < scoreList.size(); j ++) {
									Gradeone score = scoreList.get(j);
									if(score.getStuId().equals(student.getStuId())) {
										one 	= score.getGoOne();
										two 	= score.getGoTwo();
										three 	= score.getGoThree();
										four 	= score.getGoFour();
										five 	= score.getGoFive();
										six 	= score.getGoSix();
										all 	= score.getGoAll();
										break;
									}
