...
<form id="pagerForm" action="<%=basePath %>admin/office/lookup.do">
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="<%=basePath %>admin/manager/lookup.do" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar">
