...
<%
 ...
 %>
<form id="pagerForm" action="<%=basePath %>admin/opentopicinfo/lookup.do">
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="<%=basePath %>admin/opentopicinfo/lookup.do" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar">
